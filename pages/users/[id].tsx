...
import { GetUserByIdQuery, GetUserIdsQuery, Users } from '../../types/generated/graphql.tsx/graphql'
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const { data } = await apolloClient.query<GetUserByIdQuery>({
    //ユーザーID [id]を取得して特定のオブジェクトを取得するクエリ
    query: GET_USERBY_ID,
    variables: { id: params.id },
  })
  return {
    props: {
      // users_by_pk＝GET_USERBY_IDのfelid名
